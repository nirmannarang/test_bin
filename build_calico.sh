...
PATCH_URL="https://raw.githubusercontent.com/nirmannarang/test_bin/3.21.2"
...
EOF
    ...
    git clone -b v3.21.2 https://github.com/projectcalico/libcalico-go $GOPATH/src/github.com/projectcalico/libcalico-go
